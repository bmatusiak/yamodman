...
export default function Navbar(props) {
    ...
    return (<div className="sticky-top navbar bg-default px-0 shadow">
        <ul className="navbar-nav flex-md-row w-100 px-1">
            <li className="nav-item col-md-5 col-sm-12 ps-md-1">
                ...
                <div id="navbarSearch" className="w-100">
                    <input style={{ outline: '1px' }} className="form-control" type="text" placeholder="Search for an installed mod" aria-label="Search" />
                </div>
            </li>
