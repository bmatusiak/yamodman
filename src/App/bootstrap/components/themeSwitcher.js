...
function theme(imports, register) {
    ...
    theme.showActiveTheme(theme.getPreferredTheme())

    document.querySelectorAll('[data-bs-theme-value]')
        .forEach(toggle => {
            toggle.addEventListener('click', () => {
                const _theme = toggle.getAttribute('data-bs-theme-value')
                theme.setStoredTheme(_theme)
                theme.setTheme(_theme)
                theme.showActiveTheme(_theme, true)
            })
        })
